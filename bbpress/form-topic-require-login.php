		...
		<div id="no-topic-<?php bbp_topic_id(); ?>" class="bbp-no-topic">
			<div id="new-post">
				<p>
					...
					echo do_shortcode( '[notice]
<h3>Notice :: The Support Forum is closed.</h3>
<br><br>
<p>Not to worry!  Providing the top quality support you expect and we\'re known for will continue! We\'re not ending support, just changing where you submit requests. This will provide you with the best experience possible.</p>
...
<p>Have you purchased an addon for Connections such as one of our premium templates or extensions with a valid license and you need help?</p>

<p>Please open a Support Ticket in <a href="/my-account/">your user account</a>.</p>

<p>
[button size="medium" color="green" link="/my-account/support-tickets/"]Click here to open a support ticket.[/button]
</p>
...
<p>Are you using the free Connections plugin? Don\'t worry, you are still very important to us! We are still providing you with the same high quality support that we\'re known for.</p>

<p>Please open a new support topic in the <a href="https://wordpress.org/support/plugin/connections/">WordPress support forums for Connections</a>.</p>

<p>
[button size="medium" color="green" link="https://wordpress.org/support/plugin/connections/"]Click here to open a support topic.[/button]
</p>
